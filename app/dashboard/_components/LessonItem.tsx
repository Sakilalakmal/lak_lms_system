    ...
    <Link
      ...
      className={buttonVariants({
        ...
        className: cn(
          ...
          isActive &&
            !completed &&
            "bg-blue-200 dark:bg-blue-200 border-primary/50"
        ),
      })}
    >
      <div className="flex items-center gap-2.5 w-full min-w-0">
        <div className="shrink-0">
          {completed ? (
            <div className="size-5 rounded-full bg-green-600/50 dark:bg-green-500/50 flex items-center justify-center">
        ...
        <div className="flex-1 text-left min-w-0">
          ...
          {completed && (
            <p className="text-[10px] text-xs text-green-700 darl:text-green-300 font-medium mt-1">
              Completed
            </p>
          )}
