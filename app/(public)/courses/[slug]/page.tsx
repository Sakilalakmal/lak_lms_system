...
export default async function SlugPageDetails({ params }: { params: params }) {
  ...
  return (
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-3 mt-5">
                    ...
                    <div className="border-t bg-muted/20">
                      <div className="p-6 pt-4 space-y-3">
                        {chapter.lesson.map((lesson, index) => (
                          <div
                            key={lesson.id}
                            className="flex items-center gap-4 rounded-lg hover:bg-accent transition-colors p-4"
                          >
      ...
      {/* Enrollement card in here */}
      <div className="order-2 lg:col-span-1">
        <div className="sticky top-20">
          <Card className="py-0">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <span className="text-lf font-medium">Price</span>
                <span className="tex-2xl font-bold text-primary">
